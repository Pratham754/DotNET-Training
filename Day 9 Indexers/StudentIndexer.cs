...
//     {
//         // if set is removed create constructor with parameters and and to work default constructor should also be created.
//         // use private set for properties if u want to set only in constructor.
